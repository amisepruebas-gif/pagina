    ...
    <div style={{
      ...
      <div className="wrap" style={{
        ...
        <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
          ...
          Envío gratis en compras desde $499 · Devoluciones 30 días
        </span>
      ...
      <style>{`@media(min-width: 768px){.topbar-right{display:inline-flex !important}}`}</style>
    </div>
  );
}
...
function Header({ cartCount = 3 }) {
  return (
    <header style={{
      ...
      <div className="wrap" style={{
        display: "flex", alignItems: "center", gap: 24, height: 72,
      }}>
        <Logo />
        <div style={{ flex: 1, maxWidth: 560 }}>
          <Input leadingIcon="search" placeholder="Buscar productos, marcas y categorías…" />
        </div>
        <nav style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
