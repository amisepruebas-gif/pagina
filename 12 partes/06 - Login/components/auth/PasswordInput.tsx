 ...
 *
 * Tap target del toggle: 44×44. `aria-pressed` refleja el estado.
 *
 * @example <PasswordInput label="Contraseña" autoComplete="new-password" required />
 */
export const PasswordInput = forwardRef<HTMLInputElement, PasswordInputProps>(function PasswordInput(
  { label, hint, error, required, className, onFocus, onBlur,
    placeholder = "••••••••", autoComplete = "current-password", ...rest }, ref) {
    ...
    <label className="flex flex-col gap-1.5">
      ...
      <div className={cn(
        ...
        <input
          ...
          className={cn("flex-1 min-w-0 h-full bg-transparent outline-none text-[15px]", className)}
          {...rest}
        />
        <button
          type="button"
          ...
          className="size-11 inline-flex items-center justify-center rounded-full
                     bg-transparent border-0 text-text-soft cursor-pointer hover:text-text"
        >
