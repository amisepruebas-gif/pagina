...
export function EmptyState({ onClear }: EmptyStateProps) {
  return (
    <div className="py-20 px-6 text-center border-2 border-dashed border-border rounded-xl bg-surface">
      <span className="inline-flex items-center justify-center size-[72px] rounded-full bg-brand-50 text-brand-700 mb-5">
      ...
      <Button leadingIcon="refresh" onClick={onClear}>
        Limpiar filtros
      </Button>
    </div>
  );
